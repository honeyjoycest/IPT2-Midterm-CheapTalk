            ...
            <div class="card-body shadow">
                <form action="" method="post">
                  ...
                  <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                    <button class="btn btn-info"  href="{{url('register')}}" style=" letter-spacing:3px;" >Create</button>
                  </div>

                  <p class="text-center text-muted mt-5 mb-0">Have already an account? <a href="{{url('/login')}}" class=" text-info"><u>Login</u></a></p>
<br>
                </form>
                </div>
        </div>
